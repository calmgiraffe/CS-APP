...
name strings. sa points to a sockaddr struct of length salen. Host and service
name is stored in host and serv respectively. */
...
/* Transfers up to nbytes B from the current file position fd to memory location usrbuf. */
...
/* Transfers up to nbytes B from memory location usrbuf to file descriptor fd. */
...
Can be interleaved with Rio_readlineb. */
ssize_t Rio_readnb(rio_t *rp, void *usrbuf, size_t n) 
{
    ssize_t rc;
